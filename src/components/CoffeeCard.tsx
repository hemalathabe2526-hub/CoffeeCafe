...
export function CoffeeCard({
  ...
  return (
    <motion.article
      layout
      whileHover={{ y: -6 }}
      className={`group relative overflow-hidden rounded-2xl border border-white/20 bg-white/60 p-5 shadow-soft backdrop-blur transition-all hover:border-coffee-brown/40 ${
